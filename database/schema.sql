...
--
-- Host: localhost:3306
-- Tempo de geração: 05/05/2026 às 10:36
...
CREATE TABLE `automacao_acoes` (
  ...
  `tipo_acao` enum('CRIAR_CARTAO_RELACIONADO','MOVER_CARTAO','ATRIBUIR_USUARIO','ADICIONAR_TAG','REMOVER_TAG','PREENCHER_CAMPO','ARQUIVAR_CARTAO','DESARQUIVAR_CARTAO','ADICIONAR_PRAZO','MUDAR_PRIORIDADE') NOT NULL,
